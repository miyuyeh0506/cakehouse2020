...
$_SESSION['Receiver']['name'] = $_POST['name_date'];
    ...
    <div id="all">
       ...
       <?php require_once('template/footer.php'); ?>
        ...
        $(function(){
            ...
            $('input[name="delivery"]').change(function(){            //input內的[name="delivery"] 項目位置更換
                var totalprice =<?php echo $_SESSION['TotalPrice']; ?>;    
                var shipping = $(this).val();                        //(this)目前項目
                ...
                // console.log 是javascript偵錯 ,javascript用+號連接,php用.連接
