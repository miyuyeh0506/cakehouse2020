            ...
            <div class="card-body">
              ...
              <?php foreach($all_products as $products){  ?>                    
                <tr>
                      ...
                      <td>
                      <a class="btn btn-secondary" href="edit1.php?gproductID=<?php echo $products['productID']; ?>"><i class="fa fa-pencil-square-o fa-fw"></i>&nbsp;編輯</a>
                      <a class="btn btn-secondary ml-2" onclick="if(!confirm('是否確定刪除此筆資料?刪除後無法回復')){return false;};" href="delete1.php?gproductID=<?php echo $products['productID']; ?>"><i class="fa fa-fw fa-trash-o"></i>&nbsp;刪除</a>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
